...
from higpt.model.meta_hgt.meta_linear import MetaHeteroDictLinear, MetaHeteroLinear
from torch_geometric.nn.inits import ones
from torch_geometric.nn.parameter_dict import ParameterDict
from torch_geometric.typing import Adj, EdgeType, Metadata, NodeType
from torch_geometric.utils import softmax
from torch_geometric.utils.hetero import construct_bipartite_edge_index
from higpt.model.meta_hgt.hgt_constants import NODE_TYPE_DICT, EDGE_TYPE_DICT
from dataclasses import dataclass
import torch.nn as nn
from higpt.model.meta_hgt.tokenizer import tokenize
...
class MetaHGTConv(MessagePassing):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.ln_out = layernorm(out_channels)
    ...
    def forward(
        ...
        # check nan
        for k, feas in node_type_feas_dict.items(): 
            if torch.any(torch.isnan(feas)): 
                print(k, feas)
                raise ValueError
        ...
        for k, feas in edge_type_feas_dict.items(): 
            if torch.any(torch.isnan(feas)): 
                print(k, feas)
                raise ValueError
